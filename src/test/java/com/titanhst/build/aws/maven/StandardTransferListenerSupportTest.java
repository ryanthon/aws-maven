...
public final class StandardTransferListenerSupportTest {
    ...
    public void fireTransferInitiated() {
        ...
        verify(this.transferListener).transferInitiated(
                com.titanhst.build.aws.maven.matchers.Matchers.eq(new TransferEvent(this.wagon, this.resource, TransferEvent.TRANSFER_INITIATED, REQUEST_TYPE)));
    }

    @Test
    public void fireTransferStarted() {
        this.transferListenerSupport.fireTransferStarted(this.resource, REQUEST_TYPE);
        verify(this.transferListener).transferStarted(com.titanhst.build.aws.maven.matchers.Matchers.eq(new TransferEvent(this.wagon, this.resource,
    ...
    public void fireTransferProgress() {
        ...
        verify(this.transferListener).transferProgress(
                com.titanhst.build.aws.maven.matchers.Matchers.eq(new TransferEvent(this.wagon, this.resource, TransferEvent.TRANSFER_PROGRESS, REQUEST_TYPE)),
    ...
    public void fireTransferCompleted() {
        ...
        verify(this.transferListener).transferCompleted(
                com.titanhst.build.aws.maven.matchers.Matchers.eq(new TransferEvent(this.wagon, this.resource, TransferEvent.TRANSFER_COMPLETED, REQUEST_TYPE)));
    }
    ...
    public void fireTransferError() {
        ...
        verify(this.transferListener).transferError(com.titanhst.build.aws.maven.matchers.Matchers.eq(new TransferEvent(this.wagon, this.resource, exception,
                REQUEST_TYPE)));
    }
